            ...
            <div className="pt-32">
              ...
              <div className="flex flex-col gap-6 text-[2.8em] leading-relaxed text-foreground/80">
                ...
                <div className="flex items-center gap-5">
                  <span className="text-muted text-[1.2em]">•</span>
                  <span>进入</span>
                  <InlineCalloutCode className="text-[0.9em] font-mono">Koishi 控制台</InlineCalloutCode>
                  <span>→</span>
                ...
                <div className="flex items-center gap-5">
                  <span className="text-muted text-[1.2em]">•</span>
                  <span>Koishi 根目录运行</span>
                  <InlineCalloutCode className="text-[0.85em] whitespace-nowrap font-mono">
                    pnpm add koishi-plugin-kkk@{props.data.remoteVersion} -w
                  </InlineCalloutCode>
                </div>
              </div>
            </div>
